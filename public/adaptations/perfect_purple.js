...
let renderer, camera, distortion, scene, shape, size, light, light2, geometry, material, mesh, metalness, weight;
...
function create() {
  ...
  renderer = new THREE.WebGLRenderer({ canvas: document.querySelector("#preview"), antialias: true});
  ...
  //object
  geometry = new THREE.TorusKnotGeometry(size, weight, distortion, 20, 15, shape);
