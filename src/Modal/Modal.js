...
class TheModal extends Component {
  constructor(props) {
    ...
    const customConfig = this.props.customConfig
      ? {
          ...
          insertedItems: this.props.customConfig.insertedItems,
    ...
    const state = {
      ...
      insertedItems:
        customConfig.insertedItems || initState.insertedItems || [],
      // debug
      // {
      //   id: 1,
      // type: 'image'
  ...
  renderInsertedItem = (insertedItem, index) => {
    ...
    switch (insertedItem.type) {
      ...
      case "image":
        return (
          <InsertedImage ref={refCallback} imageUrl={insertedItem.imageUrl} />
        );
      default:
        return null;
    }
