...
export const svgs = [
  ...
  {
    ...svgWithSolidColor,
    thumb: "/thumbs/svgs/45.svg",
    fileName: "svgs/45",
    thumbBackgroundSize: "85%",
    aspectRatio: 126 / 84,
    initState: {
      size: { width: 1000, height: 1000 },
      configValues: {
  ...
  },
  {
    ...
    fileName: "svgs/73",
    thumbBackgroundSize: "90%",
    aspectRatio: 1183 / 801,
    initState: {
      size: { width: 1000, height: 1000 },
      configValues: {
        palette: ["#7A1C43", "#FF2200"]
      }
    }
  },
  {
    ...
    fileName: "svgs/74",
    thumbBackgroundSize: "90%",
    aspectRatio: 1206 / 805,
    initState: {
      size: { width: 1000, height: 1000 },
      configValues: {
        palette: ["#FF006A", "#FF2E00"]
      }
    }
  },
  {
